    ...
    <div>
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <FaUser />
          <p>Shared by {contentData.sharedBy}</p>
          <div className="flex items-center gap-1 rounded-md bg-gray-100 px-3 py-1 text-sm font-medium text-gray-700 transition-all hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 cursor-pointer">
            {contentData.visibility === "public" ? <FaGlobe /> : <FaKey />}
        ...
        {contentData.files.map((file) => (
          <div key={file.id}>
            {file.type === "file" ? (
              ...
              <div
                key={file.id}
                className="flex justify-between border-b border-black/10 dark:border-white/10 p-3 gap-2"
              >
                <p>Text:</p>
